...
# Downloading SonarQube 10.5.1 version to OPT folder
echo "*****Downloading SonarQube 10.5.1 version"
cd /opt 
sudo rm -rf sonarqube*
sudo wget -q https://binaries.sonarsource.com/Distribution/sonarqube/sonarqube-10.5.1.90531.zip
sudo unzip -q sonarqube-10.5.1.90531 -d /opt/sonarqube 1>/dev/null
...
cd /opt
sudo su -m ubuntu -c "./sonarqube/sonarqube-10.5.1.90531/bin/linux-x86-64/sonar.sh start 1>/dev/null"
